...
// function filterEvents(arr) {
//   const selectedType = eventTypeSelect.value === "all" ? undefined : eventTypeSelect.value;
//   const selectedDistance = eventDistanceSelect.value === "any" ? undefined : parseFloat(eventDistanceSelect.value); // Преобразуем значение в число
//   const selectedCategory = eventCategorySelect.value === "any" ? undefined : eventCategorySelect.value;
...
//   if (selectedDistance) {
//       filteredArr = filteredArr.filter((element) => element.distance === selectedDistance); // Сравниваем числа
//   }
...
// function filterEvents(arr) {
//   const selectedType = eventTypeSelect.value === "all" ? undefined : eventTypeSelect.value;
//   const selectedDistance = eventDistanceSelect.value === "any" ? undefined : parseFloat(eventDistanceSelect.value);
//   const selectedCategory = eventCategorySelect.value === "any" ? undefined : eventCategorySelect.value;
...
//   if (selectedDistance) {
//       filteredArr = filteredArr.filter((element) => element.distance === selectedDistance);
//   }
